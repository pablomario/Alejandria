...
jQuery.fn.rte = function(css_url, media_url) {
    ...
    function toolbar(iframe) {
        ...
        var tb = $("<div class='rte-toolbar' id='toolbar-"+iframe.title+"'><div>\
            ...
            <p>\
                <a href='#' class='bold'><img src='./img/icons/bold.gif' alt='negrita' /></a>\
                <a href='#' class='italic'><img src='./img/icons/italic.gif' alt='italica' /></a>\
            </p>\
            <p>\
                <a href='#' class='unorderedlist'><img src='./img/icons/unordered.gif' alt='lista desordenada' /></a>\
                <a href='#' class='link'><img src='./img/icons/link.png' alt='enlace' /></a>\
                <a href='#' class='image'><img src='./img/icons/image.png' alt='imagen' /></a>\
                <a href='#' class='disable'><img src='./img/icons/close.gif' alt='cerrar editor grafico' /></a>\
            </p></div></div>");
